...
import FlashRequest from '@/Components/FlashRequest.vue';
    ...
    <div class="min-h-screen bg-gray-100">
      <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('demands.index')" :active="route().current('demands.*')">
                  Demands
                </NavLink>
              </div>
              ...
              <div class="ml-3 relative">
                <Dropdown align="right" width="48">
                  ...
                  <template #content>
                    ...
                    <DropdownLink :href="route('myposts')">
                        My Posts
                    </DropdownLink>

                    <DropdownLink :href="route('requests')">
                        My Requests
                    </DropdownLink>
        ...
        <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }" class="sm:hidden">
          ...
          <div class="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink :href="route('demands.index')" :active="route().current('demands.*')">
              Demands
            </ResponsiveNavLink>
          </div>
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <ResponsiveNavLink :href="route('myposts')" :active="route().current('myposts')">
                My Posts
              </ResponsiveNavLink>

              <ResponsiveNavLink :href="route('requests')" :active="route().current('requests')">
                My Requests
              </ResponsiveNavLink>
