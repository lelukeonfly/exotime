...
<template>
    <main class="p-6 container max-w-7xl mx-auto">
        <Link :href="route('demands.index')" class="block bg-transparent font-semibold hover:text-white py-2 px-4 border hover:border-transparent rounded hover:bg-[#4d6ed3] border-[#4d6ed3] mb-3 inline-block">back</Link>
